...
from .fal import KSAS
from .fal import IFAL
...
def algo_query_samples(dataset_train, dataset_query, dict_users_train_total, args):
    ...
    elif args.al_method == "ksas":
        strategy = KSAS(dataset_query, dataset_train, query_net, args)
    elif args.al_method == "ifal":
        strategy = IFAL(dataset_query, dataset_train, query_net, args)
    else:
